...
namespace DungeonApp
{
    public class Testing
    {
        ...
        w1, w2, w3, w4, w5
            ...
            Console.WriteLine("You freeze. Voices echo joyously from inside the castle walls. You warily creep in and see that soldiers from the nearby kingdom have set up camp in your home. Furiously you prepare yourself.\n");
            Thread.Sleep(3000);
            ...
            "The library horrifies you. Some spellbooks have been taken, and other books have been reshelved. " +
             ...
             "You enter the large greenhouse. Instantly you can feel yourself struggle to breathe in the steamy heat. A small band of warriors had evidently come in here earlier, but were no match for the giant carnivorous plants you lovingly cultivate here.",
              "The Courtyard is filled with tents and various camping supplies. You spitefully cut loose the horses and scare them off before you are spotted."  ,
